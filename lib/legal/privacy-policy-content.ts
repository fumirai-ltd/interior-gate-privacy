...
const privacyPolicyJa: LegalDocumentWithIntro = {
  ...
  intro: [
    "本プライバシーポリシー（以下「本ポリシー」といいます。）は、Interior Gate（以下「本サービス」といいます。）における個人情報等の取扱いを定めるものです。当社（第1項で定めます。）は、個人情報の保護に関する法律（以下「個人情報保護法」といいます。）その他の関係法令、ならびに必要に応じて個人情報保護委員会のガイドライン等を踏まえ、適切に個人データ等を保護します。",
  ],
  sections: [
    {
      anchorId: "pp-0",
      heading: "1. 事業者の氏名等",
      paragraphs: [
        "名称：本サービス「Interior Gate」を運営する事業者（以下「当社」といいます。）は、本サービスに関するオンライン上の提供、付随するソフトウェアの提供、およびこれらに付随するカスタマーサポート等を行います。当社の名称、所在地、連絡先等の情報は、本サービス上の特定商取引法に基づく表記等をご確認ください。、開示等の求め、苦情、お問い合わせ等については、第2条の窓口にて対応し、所定の手続のうえ、書面等によりご回答します。",
      ],
    },
    {
      anchorId: "pp-1",
